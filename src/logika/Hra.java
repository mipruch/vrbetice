...
public class Hra implements IHra {
    ...
    public Hra() {
        ...
        platnePrikazy.vlozPrikaz(new PrikazPrecist(herniPlan));
        platnePrikazy.vlozPrikaz(new PrikazProhledej(herniPlan));
        platnePrikazy.vlozPrikaz(new PrikazSkartuj(herniPlan));
